...
!blazeContent = fromStorables $ replicate (10 * 1024 * 1024) 'x'
...
app !buf req res = res $ responseStream status200 [] $ \write flush -> do
...
main2 = do
  ...
  runSettings settings $ proxyApp2 manager dest
